...
var input = document.getElementById("enterLogin");
...
simulate(
		'2d', {
				...
				paint: function(particle) {
					...
					this.paint.circle(p.x, p.y, s, color + o +')');
					this.paint.circle(p.x, p.y, s + 1.5, color + (o * .25) + ')');
					...
					this.context.fillStyle = color + (o * .025) + ')';
					this.context.fill();
